...
@section('content')
<div>
    <canvas id="goodCanvas1" role="img" width="700px" height="250px"></canvas>
</div>
    {{-- <div class="row">
        <div class="col">
            <div class="card bg-c-blue order-card">
                <div class="card-block">
                    <h6 class="m-b-20">BIAs realizados</h6>
                    <h2 class="text-right"><i class="fa fa-cart-plus f-left"></i><span>2</span></h2>
