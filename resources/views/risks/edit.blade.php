            ...
            <form action="{{ route('risks.update', $risk) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" aria-label="Default select example" name="bia_id" id="bia_id">
                        ...
                        @foreach ($bias as $bia)
                            <option value="{{ $bia->id }}" @selected(old('bia_id', $risk->bia_id) == $bia->id)>{{ $bia->name }}
                            </option>
                        @endforeach
                    </select>
                    @error('bia_id')
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" aria-label="Default select example" name="source_id">
                        ...
                        @foreach ($sources as $source)
                            <option value="{{ $source->id }}" @selected(old('source_id', $risk->source_id) == $source->id)>{{ $source->name }}
                            </option>
                        @endforeach
                    </select>
                    @error('source_id')
                ...
                <select name="departments[]" id="select_multiple" multiple class="form-control">
                    @foreach ($departments as $department)
                        <option value="{{ $department->id }}" 
                            @selected(old('departments[]', $risk->departments->contains($department->id)))>
                            {{ $department->name }}
                        </option>
                    @endforeach
                </select>
